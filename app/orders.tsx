...
import { View, Text, ScrollView, TouchableOpacity, FlatList, RefreshControl, Animated } from 'react-native';
        ...
        >
            ...
            <View className="flex-row items-center justify-between mb-3 pb-3 border-b border-gray-200">
                <View className="flex-1">
                    <SkeletonShimmer width={120} height={16} borderRadius={4} style={{ marginBottom: 8 }} />
            ...
            <View className="mb-3">
                <SkeletonShimmer width={60} height={14} borderRadius={4} style={{ marginBottom: 8 }} />
                <View className="flex-row">
                    <SkeletonShimmer width={80} height={14} borderRadius={4} style={{ marginRight: 8 }} />
                    <SkeletonShimmer width={70} height={14} borderRadius={4} style={{ marginRight: 8 }} />
            ...
            <View className="flex-row items-center justify-between">
                <View>
                    <SkeletonShimmer width={80} height={14} borderRadius={4} style={{ marginBottom: 8 }} />
                    <SkeletonShimmer width={100} height={24} borderRadius={4} />
                </View>
                <SkeletonShimmer width={110} height={40} borderRadius={12} />
            </View>
        </View>
    );
};
        ...
        return (
            <SafeAreaView className="flex-1" style={{ backgroundColor: COLORS.background }}>
                <View className="bg-white px-4 py-4 border-b border-gray-200 flex-row items-center">
                    ...
                    <Text className="text-2xl font-bold flex-1" style={{ color: COLORS.dark }}>
                        Siparişlerim
                    </Text>
                </View>
